...
{
    public static class CL_ValidaPoliticasPass
        {
            ...
            private static bool minimoDeCaracteres(string str)
            {
                ...
                mensajeErrorLabel.Add("//VER: Lenguajes.Errores.PasMinimo8");
                return false;
            }
            ...
            private static bool tieneMayuscula(string str)
            {
                ...
                mensajeErrorLabel.Add("//VER: Lenguajes.Errores.PasMinimoMay");
                return false;
            }
            ...
            private static bool tieneMinuscula(string str)
            {
                ...
                mensajeErrorLabel.Add("//VER: Lenguajes.Errores.PasMinimoMin");
                return false;
            }
            ...
            private static bool tieneNumero(string str)
            {
                ...
                mensajeErrorLabel.Add("//VER: Lenguajes.Errores.PasMinimoNum");
                return false;
            }
            ...
            private static bool tieneCaracterEspecial(string str)
            {
                ...
                mensajeErrorLabel.Add("//VER: Lenguajes.Errores.PasMinimoEsp");
                return false;
            }
            ...
            private static bool tieneDatosPersonales(string str)
            {
                ...
                foreach (string palabra in palabras)
                {
                    ...
                    {
                        mensajeErrorLabel.Add("//VER: Lenguajes.Errores.PasDatos");
                        return false;
                    }
                }
                return true;
