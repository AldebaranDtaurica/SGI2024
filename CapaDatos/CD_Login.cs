    ...
    public class CD_Login: CD_EjecutarSP
{
    public DataTable Buscar(string usuario)
    {
        ...
        DataTable resultado = EjecutarConsultas("sp_consultarUsuario", listaParametros.ToArray());
            return resultado;
    }

     public DataTable TraerDatosPersonales()
    {
        SqlParameter param1 = new SqlParameter("@id_usuario", CSE_UserCache.id) { SqlDbType = SqlDbType.Int };
        List<SqlParameter> listaParametros = new List<SqlParameter>() { param1 };
        ...
        public void Bloquear(int id, DateTime? hBloqueo)
    {
        ...
        EjecutarConsultas("bloqueo_usuario_sp", listaParametros.ToArray(), true);//crear sp bloqueo
    }
    public void RestarIntento(int id)
    {
        SqlParameter param1 = new SqlParameter("@ID", id) { SqlDbType = SqlDbType.Int };
        List<SqlParameter> listaParametros = new List<SqlParameter>() { param1 };
        EjecutarConsultas("intento_usuario_sp", listaParametros.ToArray(), true); //crear SP intentos
    }
    ...
    public void RestaurarIntentos(int id, int intentos)
    {
        ...
        EjecutarConsultas("restablecimiento_de_intentos_sp", listaParametros.ToArray(), true); //crear SP restablecer
    }
