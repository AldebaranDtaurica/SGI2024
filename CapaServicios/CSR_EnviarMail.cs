...
namespace CapaServicios
{
    public static class CSR_EnviarMail
    {
        ...
        {
            string from = "azsolucionesgnd@Gmail.com"; //correo de la empresa
            ...
            try
            {
                ...
                {
                    Credentials = new NetworkCredential(from, "gtuguxmflctlmsta"), //correo , contraseña de la cuenta de la empresa
